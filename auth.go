...
const (
	GoogleClientID          = "904931927980-55rrfqpi7ledh0fiif5gsefeujb6erdr.apps.googleusercontent.com"
	GoogleClientSecurityKey = "speM0UgrVjHmWsEoNfoAGSwp"
	SecurityKey             = "fbapsjt6p7e0e9k3"
)
